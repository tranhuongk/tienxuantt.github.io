...
function setProperties() {
	...
	b.innerText = parkarray2[nearest_i / 2];

	var b2 = document.getElementById("Address");
	b2.innerText = parkarray3[nearest_i / 2];
...
function parkPoint(lat,lng){
	...
	x1 = lat;
	y1 = lng;
	let range=[0.2,0.5,1,2];// mảng khoảng cách để tính điểm,đơn vị : km. => explain: dưới 0.2km -> hạng 1; dưới 0.5 km -> hạng 2, ....
